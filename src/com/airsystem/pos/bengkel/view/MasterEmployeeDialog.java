...
import com.airsystem.pos.bengkel.controller.MasterEmployeeDialogController;

/**
 * @author Budi Oktaviyan
 */
public class MasterEmployeeDialog extends MasterEmployeeDialogController {

	public MasterEmployeeDialog() {
		super();
	...
	private void initComponents() {
		...
		searchCombo.setModel(new DefaultComboBoxModel(new String[] { "-- PILIH --", "Nama" }));
		...
		tableScroll.setBorder(BorderFactory.createTitledBorder(BorderFactory.createEtchedBorder(new Color(0, 0, 0), new Color(0, 0, 0)),
															   "Klik 2x untuk pilih data karyawan",
